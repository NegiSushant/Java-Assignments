...
public class HouseRobber {
    public static void main(String[] args) {
        ...
        System.out.println("Enter the total number of house: ");
        int n = in.nextInt();
        ...
        System.out.println("House with money is: "+ Arrays.toString(nums));
        System.out.println("Total money in robber is: "+rob(nums));
    }
