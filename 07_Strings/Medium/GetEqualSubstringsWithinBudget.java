...
14)Ques_1208----->>>>>
                    ...
                    corresponding substring of t with a cost less than or equal to maxCost. If there is
                    no substring from s that can be changed to its corresponding substring from t, return 0.
...
public class GetEqualSubstringsWithinBudget {
    public static void main(String[] args) {
        ...
        String t = "acde";
        int maxCode = 0;
        System.out.println(equalSubstring(s, t, maxCode));
    }
